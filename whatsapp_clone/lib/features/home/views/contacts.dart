...
class _ContactsPageState extends ConsumerState<ContactsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final contactsOnWhatsApp = searchResults.toList();
  ...
  List<Widget> _buildLocalContactsList(
    BuildContext context,
    List<User> contactsNotOnWhatsApp,
  ) {
    return [
      Padding(
        padding: const EdgeInsets.symmetric(
...
class LocalContactsList extends StatelessWidget {
  ...
  final List<User> contactsNotOnWhatsApp;
  final WidgetRef ref;
...
class WhatsAppContactsList extends StatelessWidget {
  ...
  final List<User> contactsOnWhatsApp;
  final WidgetRef ref;
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: CachedNetworkImageProvider(
                      contact.avatarUrl ?? 'https://en.gravatar.com/userimage/238463648/8cc16f6f5423605920569a634fd097eb.jpeg?size=256',
                    ),
                  ),
                  const SizedBox(
                    width: 18.0,
