...
class CameraView extends StatefulWidget {
  const CameraView({
    ...
    required this.createAttachmentsFromFiles,
  ...
  final Future<List<Attachment>> Function(List<File> files, {bool areDocuments}) createAttachmentsFromFiles;
  final Future<List<Attachment>?> Function(BuildContext context, {bool returnAttachments}) pickDocuments;
  final Future<List<Attachment>?> Function(BuildContext context, {bool returnAttachments}) pickAttachmentsFromGallery;
...
class CameraViewState extends State<CameraView>
  ...
  void handleCaptureBtnClick() async {
    ...
    if (cameraType == CameraType.photo) {
      ...
      final result = widget.createAttachmentsFromFiles([File(file.path)]);
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => AttachmentMessageSender(
          ...
          pickDocuments: widget.pickDocuments,
          pickAttachmentsFromGallery: widget.pickAttachmentsFromGallery,
        ),
      ),
    );
  }
